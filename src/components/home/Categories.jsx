...
const categories = [
    ...
    },
    {
        ...
        icon: <MdOutlineLocalLaundryService className="text-[48px] text-slate-700" />,
        bg: "bg-[#C8F2CD]",
    },
    {
        id: 4,
        ...
        <section className="py-10 md:py-14">
            <div className="max-w-7xl mx-auto px-4 md:px-6">
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-5 md:gap-7">
                  ...
                  rounded-[22px] sm:rounded-[30px] md:rounded-[38px] lg:rounded-[36px]
                  shadow-sm
                ...
                `}
                            ...
                            <p className="mt-4 text-[17px] md:text-[19px] font-black text-slate-900">{cat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
